...
app.post("/api/create", (req, res) => {
	let data = { name: req.body.name, age: req.body.age, bio: req.body.bio };
...
app.put("/api/update/", (req, res) => {
	let sql = "UPDATE users SET name='" + req.body.name + "', age='" + req.body.age + "', bio='" + req.body.bio + "' WHERE id=" + req.body.id;
	let query = conn.query(sql, (err, result) => {
		if (err) throw err;
